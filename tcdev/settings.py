...
SECRET_KEY = '_l(@s%ibh(tku5m6oyz&r9y#o20+9^1o3wl9wjwr1i6ptsfnlw'
...
LOGGING = {
    ...
    'formatters': {
        'standard': {'format': '%(asctime)s [%(threadName)s:%(thread)d] [%(name)s:%(lineno)d] [%(levelname)s]\n%(message)s'}
    },
    'filters': {
        'require_debug_false': {
    ...
    'handlers': {
        ...
        'default': {
            ...
            'filename': os.path.join(REL_SITE_ROOT + '/logs/', 'tcdev.log'),
        ...
        'api_handler': {
            ...
            'filename': os.path.join(REL_SITE_ROOT + '/logs/', 'api.log'),
            'formatter':'standard'
        },
    },
    'loggers': {
